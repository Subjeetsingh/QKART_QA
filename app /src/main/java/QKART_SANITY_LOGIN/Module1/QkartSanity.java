...
public class QkartSanity {
    ...
    public static Boolean TestCase01(RemoteWebDriver driver) throws InterruptedException {
        Boolean status;
        takeScreenshot(driver, "StartTest", "TestCase01");
        ...
        if (!status) {
            ...
            takeScreenshot(driver, "TestCaseFailed", "TestCase01");
    ...
    public static Boolean TestCase02(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            ...
            takeScreenshot(driver, "TestCaseFailed", "TestCase02");
    ...
    public static Boolean TestCase03(RemoteWebDriver driver) throws InterruptedException {
       ...
       // Thread.sleep(5000);
        ...
        if (!status) {
            ...
            takeScreenshot(driver, "TestCaseFailed", "TestCase03");
    ...
    public static Boolean TestCase04(RemoteWebDriver driver) throws InterruptedException {
        ...
        takeScreenshot(driver, "StartTestCasee", "TestCase04");
            ...
            if (result.verifySizeChartExists()) {
                ...
                if (result.openSizechart()) {
                    ...
                    if (result.validateSizeChartContents(expectedTableHeaders, expectedTableBody, driver)) {
                        ...
                        takeScreenshot(driver, "TestCaseFailed", "TestCase04");
    ...
    public static Boolean TestCase05(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            ...
            takeScreenshot(driver, "TestCaseFailed", "TestCase05");
    ...
    public static Boolean TestCase06(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            ...
            takeScreenshot(driver, "TestCaseFailed", "TestCase06");
        ...
        // Go to the login page with registered user
        login.navigateToLoginPage();
    ...
    public static Boolean TestCase07(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            ...
            takeScreenshot(driver, "TestCaseFailed", "TestCase07");
    ...
    public static Boolean TestCase08(RemoteWebDriver driver) throws InterruptedException {
        ...
        logStatus( "Start TestCase" , "TestCase 8: Verify that product added to cart is available when a new tab is opened","DONE");
        Register registration = new Register(driver);
        registration.navigateToRegisterPage();
        status = registration.registerUser("testUser", "abc@123", true);
        if (!status) {
            logStatus("Test case Failure", "Verify that product added to cart is available when a new tab is opened", "FAIL");
            takeScreenshot(driver, "TestCaseFailed", "TestCase08");
        }
        lastGeneratedUserName = registration.lastGeneratedUsername;
    ...
    public static Boolean TestCase9(RemoteWebDriver driver) throws InterruptedException {
        ...
        Thread.sleep(2000);
        System.out.println("Welcome on Privacy Policy");

        if(driver.getCurrentUrl().equals("https://crio-qkart-frontend-qa.vercel.app/privacy-policy")){
            status = true;
        }else{
            System.out.println("Not able to get on Privacy Page");
            return false;
        }
        ...
        driver.switchTo().window(handles1.toArray(new String[handles1.size()])[1]);

        Thread.sleep(2000);
        System.out.println("Welcome on About us");

        if(driver.getCurrentUrl().equals("https://crio-qkart-frontend-qa.vercel.app/aboutus")){
            status = true;
        }else{
            System.out.println("Not able to get on About us Page");
            return false;
        }
        ...
        driver.switchTo().window(handles2.toArray(new String[handles2.size()])[1]);

        Thread.sleep(2000);
        System.out.println("Welcome on Terms of Service");

        if(driver.getCurrentUrl().equals("https://crio-qkart-frontend-qa.vercel.app/terms-of-service")){
            status = true;
        }else{
            System.out.println("Not able to get on Terms of Service Page");
            return false;
        }
        ...
        logStatus("End TestCase",
                "Test Case 10: Handle with multiple window: ",
                status ? "PASS" : "FAIL");  
    ...
    public static void switchToWindow(RemoteWebDriver driver, int tabIndex)
    {
    Set<String> handles= driver.getWindowHandles();
    int i=0;
    ...
    public static Boolean TestCase10(RemoteWebDriver driver) throws InterruptedException {
        ...
        try{
        logStatus( "Start TestCase" , "TestCase 10: Verify Contact us","DONE");
        Home homePage = new Home(driver);
        homePage.navigateToHome();
        ...
        WebElement message=driver.findElement(By.xpath("//*[@placeholder='Message']"));
    ...
    public static Boolean TestCase11(RemoteWebDriver driver) throws InterruptedException {
       ...
       // takeScreenshot(driver,"StartTestCase","TestCase11");
        // TODO: CRIO_TASK_MODULE_SYNCHRONISATION -
        logStatus( "Start TestCase" , "TestCase 11: To verify that Links in the Qkart advertisment are clickable","DONE");
        Register registration = new Register(driver);
        registration.navigateToRegisterPage();
        status = registration.registerUser(lastGeneratedUserName, "abc@123", true);
        if (!status) {
            logStatus("Test case Failure", "To verify that Links in the Qkart advertisment are clickable", "FAIL");
            takeScreenshot(driver,"TestcaseFailed","TestCase011");
        }
        lastGeneratedUserName = registration.lastGeneratedUsername;
        ...
        if (!status) {
            logStatus("Step Failure", "User Perform Login Failed", status ? "PASS" : "FAIL");
            logStatus("End TestCase",
                    "Test Case 9: To verify that Links in the Qkart advertisment are clickable: ",
                    status ? "PASS" : "FAIL");
        }
        Home homePage = new Home(driver);
        homePage.navigateToHome();
        ...
        String thanksURL=driver.getCurrentUrl();
        List<WebElement> Advertisements= driver.findElements(By.xpath("//iframe"));

        status =Advertisements.size() ==3;
        logStatus("Step", "sverify that Links in the Qkart advertisment are clickable", status ? "PASS" : "FAIL");
        ...
        status= !driver.getCurrentUrl().equals(thanksURL);
        logStatus("Step", "verify that Links in the Qkart advertisment are clickable", status ? "PASS" : "FAIL");

        driver.switchTo().parentFrame();
        driver.get(thanksURL);
        ...
        logStatus("End TestCase",
                "Test Case 11: verify that Links in the Qkart advertisment are clickable: ",
                status ? "PASS" : "FAIL");
