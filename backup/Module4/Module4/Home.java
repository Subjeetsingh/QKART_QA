...
public class Home {
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            List<WebElement> cartContents = cartParent.findElements(By.xpath("//div[contains(@class,'MuiBox-root css-zgtx0t')]"));

            ArrayList<String> actualCartContents = new ArrayList<String>() {
            };
            for (WebElement cartItem : cartContents) {
                actualCartContents.add(cartItem.findElement(By.xpath("//div[contains(@class,'1gjj37g')]")).getText().split("\n")[0]);
            }
