...
public class QKART_Tests {
     ...
     */
         @Test(description = "TestCase Description", priority = 1,groups={"Sanity"})
        ...
        Assert.assertTrue(  "unable to register a new user", status);
        ...
        Assert.assertTrue( "Unable to logout to the application", status);
    ...
    @Test(description = "TestCase Description", priority = 2,groups={"Sanity"})
    ...
    public void TestCase02() throws InterruptedException {
        ...
        Assert.assertFalse("User was able to re-register with existing username ", status);
    ...
    @Test(description = "TestCase Description", priority =3,groups={"Sanity"})
    public void TestCase03() throws InterruptedException {
        ...
        soft3.assertTrue(status, "unable to search a product");
        ...
        soft3.assertTrue(status, "Unable to verify the Invalid keyword returned results");
        // if (!status) {
     ...
     * expected
     */
    @Test(description = "TestCase Description", priority = 4,groups={"Regression"})
    public void TestCase04() throws InterruptedException {
        ...
        Assert.assertTrue("Unable to search a Product", status);
        List<WebElement> searchResults = homePage.getSearchResults();
        ...
        for (WebElement webElement : searchResults) {
            ...
            if (result.verifySizeChartExists()) {
                ...
                Assert.assertTrue("unable to check the size dropdown", status);
                ...
                if (result.openSizechart()) {
                    ...
                    Assert.assertTrue("unable to close the Size chart Modal", status);
     ...
     * working correctly
     */
    @Test(description = "TestCase Description", priority = 5,groups={"Sanity"})
    ...
    public void  TestCase05(String YONEX, String Tan ) throws InterruptedException {
        ...
        // Register a new user
        status = registration.registerUser("testUser", "abc@123", true);
        Assert.assertTrue("unable to register a user", status);
        // if (!status) {
        ...
        Assert.assertTrue("unable to login in application", status );
        // if (!status) {
        ...
        Assert.assertTrue( "verify that placing order redirecting to the Thanks page",status);
     ...
     */
    @Test(description = "TestCase Description", priority = 6,groups={"Regression"})
    ...
    public void TestCase06(String Xtend, String Yarine ) throws InterruptedException {
        ...
        login.navigateToLoginPage();
        status = login.PerformLogin(lastGeneratedUserName, "abc@123");
        Assert.assertTrue("unable to login a user ", status);
        // if (!status) {
        //     logStatus("Step Failure", "User Perform Login Failed", status ? "PASS" : "FAIL");
        //     logStatus("End TestCase", "Test Case 6:  Verify that cart can be edited: ", status ? "PASS" : "FAIL");
        //     return false;
        ...
        soft6.assertTrue(status,"Unable to Xtend search a product");
        homePage.addProductToCart(Xtend);

        status = homePage.searchForProduct(Yarine);
        soft6.assertTrue(status,"Unable to Yarine search a product");
    ...
    @Test(description = "TestCase Description", priority =7,groups={"Sanity"})
    @Parameters({"Stylecon","Quantity"})
    public void TestCase07(String Stylecon, int Quantity) throws InterruptedException {
        Boolean status;
        ...
        soft7.assertTrue(status, "unable to search a product");
        ...
        soft7.assertTrue(status,"Unable to verify the InsufficientBalanceMessage ");
    ...
    @Test(description = "TestCase Description", priority = 8,groups={"Regression"})
    public  void TestCase08() throws InterruptedException {
        ...
        login.navigateToLoginPage();
        status = login.PerformLogin(lastGeneratedUserName, "abc@123");
        Assert.assertTrue("unable to perform login to application", status);
        // if (!status) {
        //     logStatus("Step Failure", "User Perform Login Failed", status ? "PASS" : "FAIL");
        ...
        Assert.assertTrue("unable to verify the message", status);
    ...
    @Test(description = "TestCase Description", priority = 9,groups={"Regression"})
    public void TestCase09() throws InterruptedException {
        ...
        login.navigateToLoginPage();
        status = login.PerformLogin(lastGeneratedUserName, "abc@123");
        Assert.assertTrue("Unable to perform a login", status);
        // if (!status) {
        //     logStatus("Step Failure", "User Perform Login Failed", status ? "PASS" : "FAIL");
        //     takeScreenshot(driver, "Failure", "TestCase09");
        //     logStatus("End TestCase",
        ...
        soft.assertTrue(status,"Verifying parent page url didn't change on privacy policy link click");
        ...
        soft.assertTrue(status,"Verifying new tab opened has Privacy Policy page heading");
        // if (!status) {
        ...
        soft.assertTrue(status,"Verifying new tab opened has Terms Of Service page heading");
        // if (!status) {
    ...
    @Test(description = "TestCase Description", priority = 10,groups={"Regression"})
    ...
    @Test(description = "TestCase Description", priority = 11,groups={"Sanity", "Regression"})
    public void TestCase11() throws InterruptedException {
        ...
        login.navigateToLoginPage();
        status = login.PerformLogin(lastGeneratedUserName, "abc@123");
        Assert.assertTrue("Unable to login into the application", status);
        // if (!status) {
        //     logStatus("Step Failure", "User Perform Login Failed", status ? "PASS" : "FAIL");
        ...
        soft1.assertTrue(status,"Unable to verify 3 Advertisements are available" );
        ...
        soft1.assertTrue(status, "Unable to verify Advertisement 1 is clickable ");
        ...
        status = !driver.getCurrentUrl().equals(currentURL);
        soft1.assertTrue(status,"Unable to verify Advertisement 2 is clickable ");
